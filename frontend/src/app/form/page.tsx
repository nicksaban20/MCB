...
function StepTwo({ formData, setFormData }: any) {
  ...
  const [samples, setSamples] = useState<
    { sampleNo: string; name: string; notes: string }[]
  >([
    { sampleNo: '', name: '', notes: '' },
    { sampleNo: '', name: '', notes: '' },
    { sampleNo: '', name: '', notes: '' },
  ...
  const syncToFormData = () => {
    setFormData((prev: any) => ({
      ...
      dnaQuantity,
      primerDetails,
      plateName: plateNameFull || plateNameLarge, // example
    ...
    <div className="max-w-5xl mx-auto p-8" onBlur={syncToFormData}>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border border-gray-200 mb-4">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-4 py-2 border-r border-gray-200 w-1/6">
                  Sample No.
                </th>
                <th className="px-4 py-2 border-r border-gray-200 w-1/3">
                  Name
                </th>
      ...
      <section>
        ...
        <p className="text-sm mb-1">
          Specify DNA Quantity:{' '}
          <span className="text-xs text-gray-500">(if known)</span>
        </p>

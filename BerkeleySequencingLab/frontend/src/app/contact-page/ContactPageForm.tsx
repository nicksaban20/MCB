...
export const emptyContactFormData: ContactFormData = {
  ...
  pi: "",
  chartstring: "",
  organization: "UC Affiliated",
};

type ContactPageProps<T extends ContactFormData> = {
  formData: T;
  setFormData: React.Dispatch<React.SetStateAction<T>>;
};

export default function ContactPageForm<T extends ContactFormData>({
  formData,
  setFormData
}: ContactPageProps<T>): JSX.Element {
        ...
        <div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-4">
                {["UC Affiliated", "Off-Campus"].map((option) => (
                  <label
                    key={option}
                    className={`inline-flex w-full items-center space-x-2 cursor-pointer border rounded-lg px-4 py-2 transition sm:w-auto ${
                      organization === option
            ...
            <div className="flex flex-col items-start gap-6 lg:flex-row lg:gap-8">
              ...
              <label
                htmlFor="poFile"
                className="flex w-full flex-col items-center justify-center border-2 border-dashed border-[#002676] rounded-lg p-6 cursor-pointer hover:border-[#001a5c] transition sm:p-8 lg:w-64"

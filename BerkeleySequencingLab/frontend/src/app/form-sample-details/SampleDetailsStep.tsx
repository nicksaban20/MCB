        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-4">
            {["Plasmid", "PCR Product", "Genomic DNA"].map((type) => (
              <label
                key={type}
                className="inline-flex w-full items-center space-x-2 cursor-pointer border border-gray-300 rounded-lg px-4 py-2 hover:border-gray-400 transition sm:w-auto"
              >
                <input
                  type="radio"
                  name="dnaType"
        ...
        <div className="mb-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full max-w-sm p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#002676] sm:w-48"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-col gap-2">
              <label className="inline-flex w-full items-center space-x-2 cursor-pointer border border-gray-300 rounded-lg px-4 py-2 hover:border-gray-400 transition sm:w-fit">
                <input
                  type="radio"
                  name="primerIncluded"
                  value="yes"
        ...
        <div className="mb-4 flex flex-col gap-4 lg:flex-row lg:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            {["Plasmid", "PCR Product", "Genomic DNA"].map((type) => (
              <label
                key={type}
                className="inline-flex w-full items-center space-x-2 cursor-pointer border border-gray-300 px-3 py-2 rounded sm:w-auto"
              >
                <input
                  type="radio"
                  name="sampleType"
